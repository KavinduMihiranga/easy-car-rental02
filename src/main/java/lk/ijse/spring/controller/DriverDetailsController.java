...
public class DriverDetailsController {
    ...
    public ResponseUtil saveDriverDetails(@RequestBody DriverDetailsDTO driverDetailsDTO) {
        driverDetailsService.saveDriverDetails(driverDetailsDTO);
        return new ResponseUtil(200,"Save",null);
    }


    @PutMapping(produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseUtil updateDriverDetails(@RequestBody DriverDetailsDTO driverDetailsDTO) {
        driverDetailsService.updateDriverDetails(driverDetailsDTO);
        return new ResponseUtil(200,"Updated",null);
    }

    @DeleteMapping(params = {"ddid"},produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseUtil deleteDriverDetails(@RequestParam String ddid) {
        driverDetailsService.deleteDriverDetails(ddid);
